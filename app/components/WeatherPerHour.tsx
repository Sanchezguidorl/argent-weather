...
function WeatherPerHour() {
  ...
  return (
    <div
      className={` p-4 transition-all duration-1000 overflow-y-visible min-h-96  h-fit w-full mt-2 flex flex-col-reverse md:flex-row flex-wrap items-center justify-between mb-8`}
    >
      ...
      {weatherListStatudDay ? (
        <><div
          className={` ${
            weatherListStatudDay ? "flex-1 max-h-[600px] h-auto" : "max-h-0 h-0"
          } flex justify-center items-center gap-2 pt-6 sm:pt-8 p-2 flex-wrap`}
        >
